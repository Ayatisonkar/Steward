...
import 'package:Steward_flutter/blocs/recent_transactions/bloc.dart';
...
import 'package:Steward_flutter/widgets/common/search_bar.dart';
import 'package:Steward_flutter/widgets/transaction_list.dart';

class RecentTransactionsPage extends StatefulWidget {
  const RecentTransactionsPage({super.key, required this.animationController});
                              ...
                              children: <Widget>[
                                Expanded(
                                  child: NestedScrollView(
                                    ...
                                    body: Container(
                                      color: StewardAppTheme.buildLightTheme()
                        ...
                        if (state is RecentTransactionsLoading) {
                          return Padding(
                            ...
                            child: SpinKitThreeBounce(
                              color:
                                  StewardAppTheme.buildLightTheme().primaryColor,
                              size: 16,
                            ),
                          );
                        }
          ...
          onSelected: (value) {
            ...
            switch (value) {
              case 'TransactionsGroupBy.Category':
                {
                  recentTransactionsBloc!.add(const GroupRecentTransactions(
