...
import 'package:Steward_flutter/blocs/transaction_summary/transaction_summary.dart';
                ...
                child: Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      boxShadow: <BoxShadow>[
                        BoxShadow(
                            color: StewardAppTheme.grey.withOpacity(0.2),
                                      ...
                                      Padding(
                                        ...
                                        child: CustomPaint(
                                          painter: CurvePainter(
                                              colors: [
                                                StewardAppTheme.nearlyDarkBlue,
                                                HexColor("#8A98E8"),
                                                HexColor("#8A98E8")
                                              ],
                                              angle: 140 +
