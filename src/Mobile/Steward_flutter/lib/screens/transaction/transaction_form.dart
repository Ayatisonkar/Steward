...
import 'package:Steward_flutter/blocs/accounts/accounts.dart';
...
import 'package:Steward_flutter/services/transaction_service.dart';
import 'package:Steward_flutter/theme/Steward_app_theme.dart';
import 'package:Steward_flutter/utils/uidata.dart';
import 'package:Steward_flutter/widgets/common/common_dialogs.dart';
import 'package:Steward_flutter/widgets/date_time_picker.dart';
...
class TransactionFormPageState extends State<TransactionFormPage> {
  ...
  Widget build(BuildContext context) {
    final transactionTextStyle = TextStyle(
                      ...
                      child: ListView(
                        ...
                        children: <Widget?>[
                          ...
                          CalculatorTextFormField(
                            ...
                            appBarBackgroundColor: StewardAppTheme.nearlyWhite,
                            operatorButtonColor:
                                StewardAppTheme.neumorphicDefault,
                            operatorTextButtonColor: StewardAppTheme.grey,
                            doneButtonColor: StewardAppTheme.nearlyDarkBlue,
                            title: 'Amount',
                            inputDecoration: InputDecoration(
                                ...
                                prefixStyle: transactionTextStyle,
                                suffixText: _account == null
                                    ? null
                                    : _account!.currencyCode,
                                suffixStyle: transactionTextStyle),
                            onSubmitted: (value) {
                              setState(() {
                                _amount = value!;
                              });
