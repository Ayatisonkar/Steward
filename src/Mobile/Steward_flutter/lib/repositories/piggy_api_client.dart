...
class PiggyApiClient {
  ...
  Future<IsTenantAvailableResult> isTenantAvailable(String tenancyName) async {
    const tenantUrl = '$baseUrl/api/services/app/Account/IsTenantAvailable';
    final response =
        await postAsync<dynamic>(tenantUrl, {"tenancyName": tenancyName});
  ...
  Future<AuthenticateResult> authenticate(
    ...
    const loginUrl = '$baseUrl/api/TokenAuth/Authenticate';
    final loginResult = await postAsync<dynamic>(loginUrl, {
