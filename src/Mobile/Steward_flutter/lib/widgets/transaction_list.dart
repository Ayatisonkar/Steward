...
class TransactionList extends StatelessWidget {
  TransactionList(
      {super.key, required this.items, this.isLoading, bool? visible})
      ...
      title: Row(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              Chip(
                backgroundColor: StewardAppTheme.incomeBackground,
                ...
                label: Text(
                  ...
                  style: TextStyle(
                    ...
                    color: StewardAppTheme.income,
                  ),
                ),
              ),
              Chip(
                backgroundColor: StewardAppTheme.expenseBackground,
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.only(
          ...
          child: NeumorphicIcon(
            ...
            style: NeumorphicStyle(
              ...
              color: transaction.amount! > 0
                  ? StewardAppTheme.income
                  : StewardAppTheme.expense,
            ),
          ),
        ),
        title: Text(
